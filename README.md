...
![Accuracy vs Noise Level](star-figures/01-noise-level.png)
...
![Dropout Ablation](star-figures/02-dropout-rate.png)
...
![Training Curves](star-figures/03-training-curves.png)
...
![Confusion Matrix](star-figures/04-confusion-matrix.png)
